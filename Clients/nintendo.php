<?php include 'header.php'; 
    ...
    try {
        ...
        $stmt = $pdo->query("SELECT * FROM articles WHERE marque = 'nintendo'");
...
<div class="container">
    ...
    <div class="phone">
        ...
        <div class="card-body">
            ...
            <a href="commande.php?titre=<?php echo urlencode($telephone['modele']); ?>&prix=<?php echo urlencode(number_format($telephone['prix'], 0, ',', ' ')); ?>&image=<?php echo urlencode($telephone['image']); ?> &stock=<?php echo urlencode($telephone['stock']); ?>" class="btn btn-custom">Acheter</a>
        </div>
    </div>
    </div>
    <?php endforeach; ?>
