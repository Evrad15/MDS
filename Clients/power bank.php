<?php include 'header.php'; 
    ...
    try {
        ...
        $stmt = $pdo->query("SELECT * FROM articles WHERE modele = 'power bank'");
...
<div class="container">
    ...
    <div class="phone">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><b><u>MARQUE:</u></b> <?php echo htmlspecialchars($telephone['marque']); ?></p>
            <p class="card-text"><b><u>CAPACITE:</u></b> <?php echo htmlspecialchars($telephone['description']); ?></p>
