<?php include 'header.php'; 
    ...
    try {
        ...
        $stmt = $pdo->query("SELECT * FROM articles WHERE marque = 'xbox'");
...
<body>
<h5><u><b>Compte de consoles PS5 à partir de 25000 FCFA</b></u></h5>
<div class="container">
    <div class="row">
    ...
    <div class="phone">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><b><u>DESCRIPTION:</u></b> <?php echo htmlspecialchars($telephone['description']); ?></p>
            <p class="card-text"><b><u>PRIX:</u></b> <?php echo htmlspecialchars(number_format($telephone['prix'], 0, ',', ' ')); ?> FCFA</p>
            <a href="commande.php?titre=<?php echo urlencode($telephone['modele']); ?>&prix=<?php echo urlencode(number_format($telephone['prix'], 0, ',', ' ')); ?>&image=<?php echo urlencode($telephone['image']); ?>" class="btn btn-custom">Acheter</a>
        </div>
    </div>
    </div>
    <?php endforeach; ?>
