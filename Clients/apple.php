<?php include 'header.php'; 
    ...
    try {
        ...
        $stmt = $pdo->query("SELECT * FROM articles WHERE marque = 'apple'");
...
<body>
<h5><u><b>Notez bien:</b></u> Ces téléphones d'occasion de version américaine, ont des batteries entre *90% et 99%*. Ne manquez pas ces offres !</h5>
<div class="container">
    <div class="row">
